 ...
 * polinomului. Constructorul va lua ca parametrii fereastra de input in care
 * s-a scris, si ca al doilea parametru, fereastra de output unde se va dori
 * afisa rezultatul.Valoarea la care se face evaluarea se va trece in
 * textfieldul de dupa cel de introducere a primului polinom
 * 
 * @author razvan
 * 
 */
public class EvalPolinomPress implements MouseListener {

	private InputWindow in;
	private OutputWindow out;

	public EvalPolinomPress(InputWindow inputWindow, OutputWindow outputWindow) {
	...
	public void mouseClicked(MouseEvent e) {
		...
		final double result = p.toPolinom(in.getTextFieldPolinom1().getText())
				.evaluare(Integer.parseInt(in.getTextValue().getText()));
