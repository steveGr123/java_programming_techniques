 ...
 * 
 */
public class DerivarePress implements MouseListener {
	private InputWindow in;
	private OutputWindow out;
	private PlotWindow outP;

	public DerivarePress(InputWindow in, OutputWindow out, PlotWindow outP) {
		this.in = in;
		this.out = out;
		this.outP = outP;
	}
	...
	public void mouseClicked(MouseEvent arg0) {
		...
		final Polinom rezultat = new Parser().toPolinom(
				in.getTextFieldPolinom1().getText()).derivare();
